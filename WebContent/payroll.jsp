...
<tr><td>First Name</td><td>Last Name</td><td>Email</td><td><td>Genrate</td></tr>
<c:forEach items="${sessionScope.temp_list1 }" var="temp">
<tr><td>${temp.firstname }</td><td>${temp.lastname }</td><td>${temp.email}</td><td>><td><a href="PayRollGenrate?flag=assign&user_id=${temp.user_id }&firstname=${temp.firstname}">Genrate</td></tr> 
</c:forEach>
