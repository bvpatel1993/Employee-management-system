...
<c:forEach items="${sessionScope.publicaccesschangelist }" var="temp">

<tr><td>${temp.d_id }</td><td>${temp.directory_name }</td><td> <a href="AllowAcessPUBLICTOAnother?flag=change&d_id=${temp.d_id }&directory_name=${temp.directory_name }">ChangeRights</td></tr> 
